...
namespace ConnectDB
{
    public class database
    {
        ...
        public DataTable Populate(string sql)
        {
        ...
        public bool ExecuteStoreProcedure2(string namestoreprocedure, List<Parametros> parametros)
        {
            try
            {
                connecttodb();
                ...
                foreach (Parametros param in parametros)
                {
                    ...
                    parameter.Size = param.longitudParametro;
                    }
                    parameter.Value = param.value;
