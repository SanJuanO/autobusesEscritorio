...
namespace Autobuses.Utilerias
{
    ...
    public class CrearTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            linea.AppendLine("ASIENTO|NOMBRE|BOLETO|TARIFA|PRECIO");
        }

        public void datos(string d1, string d2, string d3, string d4, string d5, string d6)
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine(d1+d2+d3+d4+d5+d6);
        }
